  ...
  return <div className="home">
    <div className="headerContainer">
     <img className='img-1' src={image} />
      ...
      <h3>This application has been created for the final dissertation project for the completion of MSc in Computing. <br/> The purpose of this application is to assist the communicational issues within sports teams and hopes to be used for in a means of delivering effective communication. <br/> The title for this research project is:</h3>
